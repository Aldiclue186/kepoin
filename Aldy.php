...
echo color("red"," ======================================\n");
echo color("purple","|Daftar Akun + Auto Claim Voucher Food|\n");
echo color("purple","| ______|____•_+ AUTO PIN _•___|_______|\n");
echo color("purple","| ________|______|__|_______|_________|\n");
echo color("purple","| __________|___|_____|___|___________|\n");
echo color("purple","| ____________|___060115____|_____________|\n");
echo color("purple","| Version :__BANGSAT__BERKELAS____________|\n");
...
function change(){
        ...
        echo "\n".color("purple","!] Claim voc GOFOOD1");
        ...
        goride1:
        echo "\n".color("purple","!] Claim voc GOFOOD2");
        echo "\n".color("purple","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("purple",".");
        sleep(1);
